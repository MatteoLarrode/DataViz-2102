...
```
Usually, diverging color scales are
...
In this map however, the distribution of data is such that using the median as a middle point is most likely not the rights choice. 
