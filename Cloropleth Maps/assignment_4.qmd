...
# 3rd Quartile is 296: let's round it to 300
df <- df%>%
  mutate(is_above_q3 = values > 300)

levels2 <- c("< 30,000,000", "> 300")
...
Here is an interesting [Datawrapper article](https://blog.datawrapper.de/classed-vs-unclassed-color-scales/) about this topic. 
